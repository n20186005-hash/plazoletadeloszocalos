...
export default function MapEmbed() {
  ...
  const mapsUrl = "https://maps.app.goo.gl/sR2JPeqT844vKHFr8";
    ...
    <section id="map" className="section-padding" style={{ background: 'var(--bg-secondary)' }}>
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          */}
          <iframe
            src="https://maps.google.com/maps?q=Plazoleta+de+Los+Zócalos,+Guatapé,+Antioquia,+Colombia&t=&z=15&ie=UTF8&iwloc=&output=embed"
            width="100%"
            height="450"
            style={{ border: 0 }}
            allowFullScreen
            ...
            title="Google Maps - Plazoleta de Los Zócalos"
          />
        </div>
